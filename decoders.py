...
# Nuclear Norm regularized Logistic Regression (relaxation of rank reduced logistic regression)
def nn_logreg_decoder(Xtest, Xtrain, Ztest, Ztrain, lambda_reg):
    ...
    Zpred = lr.predict(Xtest)
    loss = hamming_loss(Ztest, Zpred)
    return {"predictions": None, "loss": loss}, None, None, None, None, None, None
